...
while True:
    ...
    if pierwsza_jednostka == "celcius" and druga_jednostka == "kelvin":
        c.celcius_to_kelvin()
        break

    elif pierwsza_jednostka == "celcius" and druga_jednostka == "fahrenheit":
        c.celcius_to_fahrenheit()
        break

    elif pierwsza_jednostka == "kelvin" and druga_jednostka == "celcius":
        k.kelvin_to_celcius()
        break
    ...
    elif pierwsza_jednostka == "fahrenheit" and druga_jednostka == "celcius":
